...
//    private final static String ORGANIZATION_RESOURCE = "organization-service/api/organizations/**";
//    private final static String EUREKA_RESOURCE = "http://localhost:8671/**";
//
//    @Bean
//    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
//        http.csrf().disable().authorizeHttpRequests(
//                        authorize -> authorize.requestMatchers(DEPARTMENT_RESOURCE, EMPLOYEE_RESOURCE, EUREKA_RESOURCE, ORGANIZATION_RESOURCE)
//                                .permitAll()
